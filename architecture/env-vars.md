...
> Auto-extracted from process.env references in code

| Variable | Files |
|----------|-------|
| `ANTHROPIC_API_KEY` | `packages/core/src/driver/anthropic-driver.ts` |
| `CEREBRAS_API_KEY` | `packages/core/src/driver/presets.ts` |
| `DEEPSEEK_API_KEY` | `packages/core/src/driver/presets.ts` |
| `FIREWORKS_API_KEY` | `packages/core/src/driver/presets.ts` |
| `GROQ_API_KEY` | `packages/core/src/driver/presets.ts` |
| `MISTRAL_API_KEY` | `packages/core/src/driver/presets.ts` |
| `OPENAI_API_KEY` | `packages/core/src/driver/openai-driver.ts`, `packages/core/src/matchers/tier3/embeddings.ts` |
| `OPENROUTER_API_KEY` | `packages/core/src/driver/presets.ts` |
| `PATH` | `packages/core/src/sandbox/process/process-sandbox.ts` |
...
| `TRACEPACT_REPLAY` | `packages/vitest/src/run-skill.ts`, `packages/cli/src/commands/run.ts` |
| `TRACEPACT_TEST_TIMEOUT` | `packages/vitest/src/plugin.ts` |
| `XAI_API_KEY` | `packages/core/src/driver/presets.ts` |
<!-- END:GENERATED -->
