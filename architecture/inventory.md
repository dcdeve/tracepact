...
|------|-------|---------|------------|
| `packages/core/src/driver/openai-driver.ts` | 472 | 1 | `OpenAIDriver` |
| `packages/cli/src/commands/init.ts` | 437 | 1 | `init` |
| `packages/core/src/driver/anthropic-driver.ts` | 392 | 1 | `AnthropicDriver` |
...
| `packages/core/src/matchers/tier4/judge.ts` | 230 | 5 | `buildJudgePrompt` |
| `packages/core/src/driver/execute.ts` | 221 | 3 | `clearRegistryCache` |
| `packages/core/src/audit/rules.ts` | 205 | 5 | `toolComboRisk` |
| `packages/vitest/src/matchers.ts` | 198 | 1 | `tracepactMatchers` |
| `packages/vitest/src/run-skill.ts` | 198 | 3 | `_closePendingMcpConnections` |
...
| `packages/core/src/cassette/player.ts` | 167 | 1 | `CassettePlayer` |
| `packages/core/src/driver/registry.ts` | 157 | 1 | `DriverRegistry` |
...
| `packages/core/src/mcp/client.ts` | 132 | 3 | `McpClientConfig` |
...
| `packages/core/src/matchers/tier3/embedding-cache.ts` | 102 | 4 | `embedWithCache` |
...
| `packages/core/src/driver/semaphore.ts` | 88 | 1 | `Semaphore` |
